(function () {
  const assetLibrary = [
    ...
    { label: "Sale pony archive", path: "../assets/pony-vintage-white-wide.jpg" },
    { label: "Green pony jump", path: "../assets/pony-possum-brick-jump.png" },
    { label: "Just ponies stall", path: "../assets/pony-possum-stall-cuddle.jpg" },
    { label: "Catch ride cutout", path: "../assets/atig-catchride-cutout.png" },
    { label: "Shipping trailer", path: "../assets/pony-handler-trailer.jpg" },
    { label: "Show grounds", path: "../assets/atig-showgrounds-deeprun.jpeg" },
    { label: "Show venue entrance", path: "../assets/atig-showgrounds-pbiec.jpg" },
    { label: "Pony lineup", path: "../assets/atig-pony-show-lineup.jpg" },
    { label: "Pony Finals", path: "../assets/atig-pony-finals-dukes.jpg" },
    { label: "Kids rider", path: "../assets/pony-tiny-rider-bw.jpg" },
    { label: "Old show memory", path: "../assets/pony-vintage-with-mom.jpg" },
    { label: "Barn aisle", path: "../assets/atig-show-barn-aisle.jpg" },
    { label: "Dark pony portrait", path: "../assets/atig-dark-pony-portrait.png" },
    { label: "Tryon Fall winner board", path: "../assets/sam-tryon-fall-pony.jpg" },
    { label: "Small child with grazing pony", path: "../assets/sam-kid-grazing-pony.jpg" },
    { label: "Walk to the barn", path: "../assets/sam-walk-to-barn-pony.jpg" },
    { label: "Smiling pony ride", path: "../assets/sam-smiling-kid-pony-ride.jpg" },
    { label: "Girl with grazing pony", path: "../assets/sam-girl-grazing-pony.jpg" },
    { label: "White pony jump detail (small)", path: "../assets/sam-white-pony-jump-thumb.png" },
    { label: "Virginia show grounds", path: "../assets/sam-showgrounds-virginia-wide.jpeg" },
    { label: "Deep Run ring view", path: "../assets/sam-deep-run-show-ring.jpeg" },
    { label: "Show scoreboard (small)", path: "../assets/sam-scoreboard-thumb.jpeg" },
    { label: "Pony Finals trophies", path: "../assets/sam-pony-finals-trophy.JPG" },
    { label: "Bay pony in hand", path: "../assets/sam-bay-pony-inhand.JPG" },
    { label: "Pony Finals scoreboard", path: "../assets/sam-pony-finals-scoreboard.JPG" },
    { label: "Parent and child pony walk", path: "../assets/sam-parent-child-pony-walk.jpeg" },
    { label: "Bay hunter round", path: "../assets/sam-bay-hunter-round.jpg" },
    { label: "Ring view wide", path: "../assets/sam-ring-view-pony.jpg" },
    { label: "Pony ears color", path: "../assets/sam-pony-ears-color.jpg" },
    { label: "Pony ears black and white", path: "../assets/sam-pony-ears-bw.jpg" },
    { label: "Jazz over fences", path: "../assets/sam-jazz-pony-finals-over-fences.jpg" },
    { label: "Pony Finals main field", path: "../assets/sam-pony-finals-main.png" },
    { label: "White pony legs cutout", path: "../assets/sam-white-pony-legs-cutout.png" },
    { label: "Barre Dukes Pony Finals", path: "../assets/sam-pony-finals-barre-dukes.jpg" }
  ];
